    ...
    <div  class="mehsul-al">
        ...
        <div class="mehsulal-content px-2 flex bg-[#fff] fixed inset-0 z-[100] mx-auto top-[25%] lg:top-[30%] h-[67%] flex-col items-center justify-center w-[95%] lg:w-[25%]">
            ...
            <div class="sebet-at flex items-end justify-end w-[80%] py-4">
                <button class="bg-[#0F9675] cursor-pointer rounded-md text-white font-bold p-[5px]" onclick="addBasket('${img}', '${name}', '${price}', '${id}')">Səbətə at  </button>
            </div>
        </div>
    </div>`
...
function addBasket(img, name, price, id) {
    ...
    say.innerHTML=  "Səbətinizdə məhsulların sayı: "+  basket.length
    saydes.innerHTML=  "Səbətinizdə məhsulların sayı: "+  basket.length
    sebeteYaz()
    const tamcem = basket.reduce((total, item) => total + item.opsi, 0);
...
>>>>>>> d7e8c4aaa1fa73bdeb88e22ef65a408a05fa0956
>>>>>>> 3d09d0a27f1c387f2ae0d45a9c9aa9293e2ae1c5
